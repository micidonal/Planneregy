...
//               let selectedDate = new Date(today.getFullYear(), this.props.monthCalCurrDate.getMonth(), item);
//               let isWithinStrategy = selectedDate >= strategyStartDate && selectedDate <= strategyEndDate;

//               // Default background
//               let backColor = this.props.monthCalCurrDate.getMonth() === today.getMonth() ? "white" : "#f5f5f5";

//               // Find weather icon for this date
//               let iconNum = "";
//               let iconEmoji = "";
...
//                   let eventDate = new Date(newEvent.start);
//                   if (eventDate.getHours() < 12) {
//                     morningEvents.push(newEvent);
//                   } else {
//                     afternoonEvents.push(newEvent);
//                   }
//                 }
//               }
...
//                     alignItems: "center",
//                     backgroundColor: item !== -1 ? backColor : "transparent",
//                     borderWidth: item !== -1 ? 1 : 0,
//                     borderColor: "#ddd",
//                   }}
//                 >
//                   {item !== -1 && (
...
//                     let feelingEmoji = "";
//                     if (event.feeling) {
//                       feelingEmoji = event.feeling === "Positive" ? "🙂" :
//                         event.feeling === "Negative" ? "😕" :
//                           "😑";
//                     }

//                     return (
//                       <View
//                         key={`morning-event-${item}-${index}`}
//                         style={{
//                           width: "100%",
//                           backgroundColor: event.isActivityCompleted ? "green" :
//                             event.isPlanned === "added-activity" ? "blue" :
//                               event.isReported ? "yellow" : "gray",
//                           borderRadius: 5,
//                           height: 15,
//                           alignItems: "center",
//                           justifyContent: "center",
...
//                     return (
//                       <View
//                         key={`afternoon-event-${item}-${index}`}
//                         style={{
//                           width: "100%",
//                           backgroundColor: event.isActivityCompleted ? "green" :
//                             event.isPlanned === "added-activity" ? "blue" :
